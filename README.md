...
### Entusiasta de Tecnologia & Desenvolvedora em Construção
...
- 🔭 Atualmente trabalhando em projetos para consolidar **Lógica de Programação**.

- 🌱 Aprofundando em **Java Orientado a Objetos** e APIs REST.

- 🐍 Automatizando tarefas repetitivas com **Python**.

- 🛠️ Explorando o básico de **Lua** para scripts rápidos e modding.



>"Programar é a arte de organizar o caos em lógica funcional."
